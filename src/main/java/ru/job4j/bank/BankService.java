...
public class BankService {
    ...
    /**
     * Метод добавляет пользователя в систему.По умолчанию нужно добавить пустой список -
     * new ArrayList<Account>().В методо есть проверка, если такой есть второго добавлять не нужно!
